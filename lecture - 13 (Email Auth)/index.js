...
//http://localhost:8000/verifytoken/eyJhbGciOiJIUzI1NiJ9.a3NzaW5naGthcmFuMTNAZ21haWwuY29t.YVyytJLuQB4MF7pcp0e2dERaKevVDm8ar_PIYm7bv0Y
...
app.post("/login", async (req, res) => {
  ...
  try {
    ...
    if (!userDb.isEmailAuthenticated) {
      return res.send({
        status: 400,
        message: "Please verifiy your email id before login",
      });
    }
...
app.post("/edit-item", rateLimitng, isAuth, async (req, res) => {
  console.log(req.body);
